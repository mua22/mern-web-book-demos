...
This is the third and most advanced of [three variants](../README.md) of the same resume
content - see that page first for how it compares to
[Variant 1: Plain HTML](../01-plain-html/) and [Variant 2: Basic CSS](../02-basic-css/).
